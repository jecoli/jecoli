...
public class IntegerSetRepresentationFactory extends AbstractSetRepresentationFactory<Integer> implements Serializable {
	...
	public IntegerSetRepresentationFactory(int maxElement, int maxSetSize, int minSetSize, int numberObjectives) {
		this(maxElement, minSetSize, maxSetSize, minSetSize, maxSetSize, numberObjectives);
	}
